...
typedef struct IHM_Window
{
    ...
    void (*onClick)(struct IHM_Window *window, int x, int y, int bouton);
...
/**
 * @brief Fonction exécutée automatiquement lorsqu'un click de souris est détecté dans la fenêtre.
 * @param self Pointeur d'autoréférence sur la structure de fenêtre concernée.
